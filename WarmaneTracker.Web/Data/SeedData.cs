        ...
        newPlan.Steps.AddRange(new[]
{
    ...
    Step(13, 300, 310, "Volatile Healing Potion (A)", craftWowItemId: 33732, craftCount: 15,
        reagents: new[] { R(13464,"Golden Sansam",15), R(22785,"Felweed",15), R(18256,"Imbued Vial",15, isVendor: true) }),

    Step(14, 300, 310, "Adept's Elixir (B)", craftWowItemId: 33740, craftCount: 15,
        reagents: new[] { R(13463,"Dreamfoil",15), R(22785,"Felweed",15), R(18256,"Imbued Vial",15, isVendor: true) }),

    Step(15, 310, 325, "Elixir of Healing Power", craftWowItemId: 28545, craftCount: 25,
        reagents: new[] { R(13464,"Golden Sansam",25), R(22786,"Dreaming Glory",25), R(18256,"Imbued Vial",25, isVendor: true) }),
    ...
    Step(19, 350, 360, "Resurgent Healing Potion", craftWowItemId: 53838, craftCount: 10,
        reagents: new[] { R(36901,"Goldclover",20), R(18256,"Imbued Vial",10, isVendor: true) }),

    Step(20, 360, 365, "Icy Mana Potion", craftWowItemId: 53839, craftCount: 5,
        reagents: new[] { R(36907,"Talandra's Rose",10), R(18256,"Imbued Vial",5, isVendor: true) }),

    Step(21, 365, 375, "Spellpower Elixir", craftWowItemId: 53842, craftCount: 10,
        reagents: new[] { R(36901,"Goldclover",10), R(36904,"Tiger Lily",10), R(18256,"Imbued Vial",10, isVendor: true) }),
    ...
    Step(23, 380, 385, "Potion of Nightmares", craftWowItemId: 53900, craftCount: 5,
        reagents: new[] { R(36901,"Goldclover",5), R(36907,"Talandra's Rose",10), R(18256,"Imbued Vial",5, isVendor: true) }),

    Step(24, 385, 395, "Elixir of Mighty Strength", craftWowItemId: 54218, craftCount: 12,
        reagents: new[] { R(36904,"Tiger Lily",24), R(18256,"Imbued Vial",12, isVendor: true) }),

    Step(25, 395, 400, "Elixir of Mighty Agility", craftWowItemId: 53840, craftCount: 5,
        reagents: new[] { R(36901,"Goldclover",10), R(36903,"Adder's Tongue",10), R(18256,"Imbued Vial",5, isVendor: true) }),

    Step(26, 400, 401, "Northrend Alchemy Research", craftWowItemId: 60893, craftCount: 1,
        reagents: new[] { R(36901,"Goldclover",10), R(36903,"Adder's Tongue",10), R(36907,"Talandra's Rose",4), R(40411,"Enchanted Vial",4, isVendor: true) }),

    // 26A / 26B
    Step(27, 401, 405, "Elixir of Mighty Agility (A)", craftWowItemId: 53840, craftCount: 7,
        reagents: new[] { R(36901,"Goldclover",14), R(36903,"Adder's Tongue",14), R(18256,"Imbued Vial",7, isVendor: true) }),

    Step(28, 401, 405, "Elixir of Mighty Thoughts (B)", craftWowItemId: 60367, craftCount: 7,
        reagents: new[] { R(37921,"Deadnettle",14), R(36907,"Talandra's Rose",7), R(18256,"Imbued Vial",7, isVendor: true) }),

    Step(29, 405, 415, "Indestructible Potion", craftWowItemId: 53905, craftCount: 10,
        reagents: new[] { R(36906,"Icethorn",20), R(18256,"Imbued Vial",10, isVendor: true) }),

    Step(30, 415, 425, "Runic Mana Potion", craftWowItemId: 53837, craftCount: 30,
        reagents: new[] { R(36905,"Lichbloom",60), R(36901,"Goldclover",30), R(18256,"Imbued Vial",30, isVendor: true) }),
    ...
    Step(34, 435, 450, "Flask of Endless Rage (A)", craftWowItemId: 53903, craftCount: 15,
        reagents: new[] { R(36905,"Lichbloom",105), R(36901,"Goldclover",45), R(36908,"Frost Lotus",15), R(40411,"Enchanted Vial",15, isVendor: true) }),

    Step(35, 435, 450, "Flask of Pure Mojo (B)", craftWowItemId: 54213, craftCount: 15,
        reagents: new[] { R(36906,"Icethorn",105), R(40195,"Pygmy Suckerfish",45), R(36908,"Frost Lotus",15), R(40411,"Enchanted Vial",15, isVendor: true) }),

    Step(36, 435, 450, "Flask of Stoneblood (C)", craftWowItemId: 53902, craftCount: 15,
        reagents: new[] { R(36905,"Lichbloom",105), R(37704,"Crystallized Life",45), R(36908,"Frost Lotus",15), R(40411,"Enchanted Vial",15, isVendor: true) }),

    Step(37, 435, 450, "Flask of the Frost Wyrm (D)", craftWowItemId: 53901, craftCount: 15,
        reagents: new[] { R(36905,"Lichbloom",75), R(36906,"Icethorn",75), R(36908,"Frost Lotus",15), R(40411,"Enchanted Vial",15, isVendor: true) }),
});
